      ...
      <div className="w-[85vw] h-[85vh] bg-[#fcfcfa] rounded-[1vw] shadow-[2px_0_9px_rgba(0,0,0,0.1)]">
        <div className='flex w-full h-full justify-center items-center p-[2vw]'>
          <div className='w-[45%] h-full pr-[4vw]'>
            <div className="w-full h-full flex flex-col gap-[2vw] justify-evenly items-center">
              <div className="w-full flex flex-col gap-[1vw] items-center">
                ...
                <p className="spl text-center text-[1vw] font-semibold text-[#FC9412]">{p1[active]}</p>
              </div>
              <div><div className="w-[2vw] h-[0.2vw] rounded bg-[#505254]" /></div>
              <p className="spl text-[#505254] font-semibold text-[1vw]">{p2[active]}</p>
              <p className="spl text-[#505254] font-semibold text-[1vw]">{p3[active]}</p>
            </div>
          </div>
          <div className=" relative">
            <div onClick={() => minusActive()} className={`absolute x-5 w-[3vw] h-[3vw] ${(active===0)?'opacity-70':'opacity-100 active:scale-95'} right-0 top-[-3vw] bg-[#FC9412]`}>
            ...
            <div onClick={() => plusActive()} className={` absolute z-5 w-[3vw] h-[3vw] ${(active===imgPath.length-1)?'opacity-70':'opacity-100 active:scale-95'} left-0 bg-[#fcfcfa]`}>
          ...
          <div className='w-[45%] h-full '>
            <Image ref={imgRef} src={imgPath[active]} className='w-full z-1 object-cover h-full rounded-[1vw]' alt="Burger Imgae" loading="eager" width={585} height={530} />
          </div>
        </div>
