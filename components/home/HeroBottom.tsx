  ...
  return (
    <div className=' w-full h-[22%] font-[fontbold] flex'>
              ...
              {burgerInfoContext.map((burgerInfo, index) => {
                return (<div key={index} className='flex gap-[.5vw] border-2 overflow-hidden border-[#eaa857] rounded-[1vw] bg-[#fcfcfa]'>
                  ...
                  <div className='flex flex-col my-[0.4vw]'>
                    ...
                    <h1 className='text-[1.3vw] leading-[1.6vw]'>{burgerInfo.name.split(" ").slice(0, 2).join(" ")} <br />
      ...
      <div className='w-[50%] h-full flex gap-[1vw] items-end justify-end pr-[7vw] pb-[2vw]'>
        <button onClick={LeftClickHandeler} className='active:scale-95'><Image className='w-[3vw] h-fit bg-[#FFF8EE] p-[0.3vw] border border-[#50525449] rounded-full' src="/svg/arrow-left.svg" loading="eager" alt="burger-logo" width={50} height={50} /></button>
        <button onClick={RightClickHandeler} className='active:scale-95'><Image className='w-[3vw] h-fit bg-[#FFF8EE] p-[0.3vw] border border-[#50525449] rounded-full' src="/svg/arrow-right.svg" loading="eager" alt="burger-logo" width={50} height={50} /></button>
      </div>
    </div>
  )
}
